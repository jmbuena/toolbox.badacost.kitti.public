function test_kitti_badacost_detector(dataDir, dataOutputDir, ...
...
if(~exist(detectionsFile,'file'))
  ...
  acfDetectBadacost( imgNms, detector, detectionsFile );  
end
