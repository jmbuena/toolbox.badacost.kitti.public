...
%SAVE_PATH_ROOT = fullfile(KITTI_PATH, sprintf('CROSS_VAL_%d_FOLD_SPLITS', NUM_FOLDS));
SAVE_PATH_ROOT = fullfile(PREPARED_DATA_PATH, sprintf('CROSS_VAL_%d_FOLD_SPLITS', NUM_FOLDS));
